-- Backfill March 2025 Part 2 (16-31)
-- Run AFTER deploying 20251023_fix_cancelled_in_metrics.sql

DO $$
DECLARE
  processing_date DATE := '2025-03-16';
  end_date DATE := '2025-03-31';
  days_processed INT := 0;
BEGIN
  RAISE NOTICE '🔄 Backfilling March 2025 Part 2 (Mar 16-31)';
  ...
  RAISE NOTICE '✅ March 2025 Part 2 complete: % days', days_processed;
END $$;
