-- Backfill September-October 2025
-- Run AFTER deploying 20251023_fix_cancelled_in_metrics.sql

DO $$
DECLARE
  processing_date DATE := '2025-09-01';
  end_date DATE := CURRENT_DATE;  -- Up to today
  days_processed INT := 0;
BEGIN
  RAISE NOTICE '🔄 Backfilling Sept-Oct 2025 (2025-09-01 to %)', end_date;
  ...
  RAISE NOTICE '✅ Sept-Oct 2025 complete: % days', days_processed;
END $$;
