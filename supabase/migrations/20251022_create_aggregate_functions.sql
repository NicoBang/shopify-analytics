-- Create SQL functions for daily aggregation
-- These functions are called by Edge Functions to aggregate metrics for a specific date

-- ============================================================================
-- 1. aggregate_color_metrics_for_date(target_date DATE)
-- ============================================================================
...
AS $$
BEGIN
  -- Based on 20251020_backfill_daily_color_metrics_corrected.sql
  -- Aggregates daily_color_metrics for a single date
...
-- ============================================================================
-- 2. aggregate_sku_metrics_for_date(target_date DATE)
-- ============================================================================
...
AS $$
BEGIN
  -- Based on 20251020_backfill_daily_sku_metrics_corrected.sql
  -- Aggregates daily_sku_metrics for a single date
...
GRANT EXECUTE ON FUNCTION aggregate_color_metrics_for_date(DATE) TO service_role;
GRANT EXECUTE ON FUNCTION aggregate_sku_metrics_for_date(DATE) TO service_role;
