-- Fix daily_color_metrics for 2025-09-09 WITHOUT meta CTE
-- Join directly with product_metadata like SKU migration does
...
-- NO meta CTE! Get one row per artikelnummer directly from product_metadata
